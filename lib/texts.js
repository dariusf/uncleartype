...
var Texts = (function () {
    ...
    var endings = [
        ...
        'This is the end of the time you will spend here. Go forth and indulge yourself in something else.',
        'Your task is completed. Good robot.',
        'You are finished. What will you do now? Are you without direction?',
        'That is all. Now what will you do with the rest of your life?',
        'Very nice effort. Unfortunately nothing will come of it.',
    ...
    var titles = [
        ...
        'yes, type as we say',
        'no peeking',
        'you won\'t learn if you peek',
        'visual cues are unbecoming of you',
        'do not look',
    ];
    ...
    return {
        ...
        randomTitle: randomFrom(titles),
        defaultTitle: 'close your eyes',
    };
